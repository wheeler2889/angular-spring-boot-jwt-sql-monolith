...
import state.mn.us.IntegrationTest;
import state.mn.us.config.Constants;
import state.mn.us.domain.User;
import state.mn.us.repository.AuthorityRepository;
...
import state.mn.us.service.dto.PasswordChangeDTO;
import state.mn.us.web.rest.vm.KeyAndPasswordVM;
import state.mn.us.web.rest.vm.ManagedUserVM;
